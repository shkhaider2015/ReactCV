...
const ContactComp = () =>
{
  ...
  <form method="POST" action="#" id="contact-form" className="contact-form" data-toggle="validator">
    <div className="row">
      <div className="form-group col-12 col-md-6">
        <i className="font-icon icon-user" />
        {/* <input type="text" className="input input__icon form-control name" id="Contact" name="name" placeholder="Full name" required={true} autoComplete="on" oninvalid="setCustomValidity('Fill in the field')" onkeyup="setCustomValidity('')" /> */}
        <div className="help-block with-errors" />
      </div>
      <div className="form-group col-12 col-md-6">
        <i className="font-icon icon-envelope" />
        {/* <input type="email" className="input input__icon form-control email" id="Contact" name="email" placeholder="Email address" required="required" autoComplete="on" oninvalid="setCustomValidity('Email is incorrect')" onkeyup="setCustomValidity('')" /> */}
        <div className="help-block with-errors" />
      </div>
      <div className="form-group col-12 col-md-12">
        {/* <textarea className="textarea form-control message" id="message" name="message" placeholder="Your Message" rows={4} required="required" oninvalid="setCustomValidity('Fill in the field')" onkeyup="setCustomValidity('')" defaultValue={""} /> */}
        <div className="help-block with-errors" />
      </div>
    </div>
    <div className="row">
